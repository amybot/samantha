defmodule Samantha.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      {Lace.Redis, %{
          redis_ip: System.get_env("REDIS_IP"), redis_port: 6379, pool_size: 10, redis_pass: System.get_env("REDIS_PASS")
        }},
    ...
    #{:ok, shard_pid} = Samantha.InternalSupervisor.start_child Samantha.Shard.child_spec(%{
    #    token: System.get_env("BOT_TOKEN"), 
    #    shard_count: shard_count
    #  })
    Logger.info "Waiting for shard to be ready for AMQP connect..."
    :timer.sleep 1000
