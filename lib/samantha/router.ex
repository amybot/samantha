defmodule Samantha.Router do
  ...
  defp get_voice_events(guild_id, channel_id) do
    ...
    clen = GenServer.call Samantha.Queue, {:length, cq}
    glen = GenServer.call Samantha.Queue, {:length, gq}
    # If we have both events...
    if clen == 1 and glen == 1 do
      ...
      # Otherwise, just try again in a little bit
